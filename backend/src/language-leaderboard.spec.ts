...
import { startApp, stopApp } from "./language-leaderboard";
import { Express } from "express";

async function setInitialVotes(app: Express, votes: any) {
  await request(app).put("/admin/configureVotes").send(votes).expect(200);
}
